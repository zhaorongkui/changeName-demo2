<template>
  <div class="content-main">
    <div class="authorize-top-extra" style="display: flex;justify-content: end">
    ...
    <!-- 数据预览 -->
<!--    <div v-if="activeTab === 'preview'" class="table-operate">-->
<!--      <div class="search-form" v-if="sourceType === 'business'" style="justify-content: flex-start">-->
<!--        <el-radio-group v-model="previewType" class="preview-type" @change="handlePreviewTypeChange">-->
<!--          <el-radio-button label="按组织" value="organization" />-->
<!--          <el-radio-button label="按时间范围" value="timeRange" />-->
<!--        </el-radio-group>-->
<!--        <el-input-->
<!--          v-if="previewType === 'organization'"-->
<!--          class="search-input"-->
<!--          placeholder="请输入组织"-->
...
<!--          </template>-->
<!--        </el-input>-->
<!--        <span class="date-range" v-if="previewType === 'timeRange'">-->
<!--          <el-date-picker-->
...
<!--        </el-select>-->
<!--        <el-button type="primary" @click="handleResetPreviewQuery">重置</el-button>-->
<!--      </div>-->
<!--    </div>-->
    <div v-if="activeTab === 'preview'" class="data-table-container">
      ...
      >
        ...
        <el-table-column
          v-for="field in businessObjectMetaData"
          :key="field.fieldName"
          :label="`${field.description}`" :prop="field.fieldName"
          min-width="120"
        >
          <!-- <el-table-column :label="`${field.description}`" :prop="field.fieldName"> </el-table-column> -->
        </el-table-column>
      </el-table>
      <be-pager
          v-model:current-page="tableConfigPreview.paginationConfig.currentPage"
          v-model:page-size="tableConfigPreview.paginationConfig.pageSize"
          :total="tableConfigPreview.paginationConfig.total"
          :list="tableDataPreview"
          :page-sizes="[10, 20, 30, 50]"
