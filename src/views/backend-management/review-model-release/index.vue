<template>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-main">
        <div class="search-criteria">
          <AdvancedSearch :formItemList="formItemList" @on-search="handleFilterSearch" @on-reset="handleFilterReset"  @onClear="handleFilterClear" >
  ...
  <!-- 试用详情 -->
  <modelDetail v-if="isShowModelDetail" @close="handleCloseModelDetail" :itemModelId="itemModelId" :busId="busId"></modelDetail>
...
import modelDetail from '../review-model-deploy/components/modelDetail.vue'
...
const tableColumns = computed(() => {
  return [
    ...
    },
    {
      ...
      width: 220,
      format: (row) => {
        return row.busType?.toString() === '1' ? '模型发布' : '模型下架'
      }
    },
    {
      prop: 'reviewStatus',
...
const goDetail = (row) => {
  router.push({
    path: '/backend-management/review-management/review-model-release/check',
    query: {
