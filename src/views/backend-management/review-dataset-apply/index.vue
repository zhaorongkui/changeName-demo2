<template>
  <div style="height: 100vh;"
    v-if="['review-dataset-applay-detail', 'review-dataset-applay-check'].includes(`${String($route.name)}`)">
...
import { getApplicationApprovalList } from "@/api/backStageManage"
...
const handleFilterReset = () => {
  ...
  formData.value.applicationStatus = '1'
