...
import { mockTableData, type TableDataItem } from '../model-ontrial/tableData'
import { Search } from '@element-plus/icons-vue'
import selectModel from '../model-ontrial/components/selectModel.vue'
...
const { t } = useI18n()
import trialRecord from '../model-ontrial/components/trialRecord.vue'
import { getmodelApprovallList,getModelTrialDetail } from '@/api/modelManage'
// 试用记录接口
...
const getOntrialList = ()=> {
  ...
  getmodelApprovallList({
    currentPage: tableConfig.value.paginationConfig.currentPage,
    pageSize: tableConfig.value.paginationConfig.pageSize,
    modelName: formData.value.searchWord,
  }).then((res) => {
    if(res.success){
