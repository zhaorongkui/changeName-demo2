        ...
        <div class="content-main">
          <div class="search-container">
            <div class="table-search">
              <el-form :inline="true" :model="formData" class="demo-form-inline" @submit.native.prevent>
                <el-form-item>
                  <el-input v-model="versionAlias" style="width: 240px" placeholder="搜索数据集名称" clearable
          ...
          <div class="data-table-container" v-loading="loading">
            <el-table :data="tableData" style="width: 100%" max-height="400px">
              ...
              <el-table-column label="版本" width="180" show-overflow-tooltip>
              ...
              <el-table-column prop="aliasName" label="版本别名" width="120"/>
              ...
              <el-table-column prop="developLanguage" label="编程语言" width="200"/>
              <el-table-column prop="releaseStatus" label="发布状态" width="120"/>
              <el-table-column prop="deploymentStatus" label="部署状态" width="120"/>
...
// 加载表格数据
const loadTableData = () => {
  console.log(props.currentModel,'currentmodel')
  loading.value = true
  getPageVersion({
