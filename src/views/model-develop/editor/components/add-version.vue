<template>
<!--  新建版本-->
  <el-drawer v-model="drawer" title="I am the title" :with-header="false" @close="handleClose" :modal="false">
    <el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick">
      <el-tab-pane label="模型信息" name="first">
        <addVersionForm ref="modelFormRef" :currentModel="currentModel"></addVersionForm>
      </el-tab-pane>
      <el-tab-pane label="关联数据集" name="dataSet">
        <addModelDataset></addModelDataset>
      </el-tab-pane>
      <el-tab-pane label="参数配置" name="config">
        <addModelParameterConfig></addModelParameterConfig>
      </el-tab-pane>
    </el-tabs>
